...
static const struct subcmd {
	...
	{ "scavenge",cmd_scavenge,"scavenge deleted-file remnants (names + carve)" },
	{ "ncheck",  cmd_ncheck,  "inode->path (-s: setuid/setgid/device audit)" },
	{ "quot",    cmd_quot,    "blocks + files per owner"                 },
	{ "du",      cmd_du,      "disk usage per directory subtree"         },
	{ "df",      cmd_df,      "block + inode usage summary"              },
	{ "labelit", cmd_labelit, "read/set the volume label"                },
